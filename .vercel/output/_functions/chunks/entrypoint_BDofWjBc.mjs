...
import { R as ROUTE_TYPE_HEADER, l as REROUTE_DIRECTIVE_HEADER, n as bold, o as red, y as yellow, p as dim, q as blue, t as decryptString, v as createSlotValueFromString, r as renderComponent, b as renderTemplate, D as DEFAULT_404_COMPONENT, w as renderSlotToString, x as renderJSX, z as chunkToString, A as isRenderInstruction, B as originPathnameSymbol, C as ASTRO_VERSION, E as clientLocalsSymbol, G as clientAddressSymbol, H as responseSentSymbol$1, I as renderPage, J as REWRITE_DIRECTIVE_HEADER_KEY, K as REWRITE_DIRECTIVE_HEADER_VALUE, L as renderEndpoint, M as REROUTABLE_STATUS_CODES, O as commonjsGlobal } from './astro/server_D_sz6CSQ.mjs';
import { t as appendForwardSlash, u as joinPaths, A as AstroError, v as i18nNoLocaleFoundInPath, R as ResponseSentError, w as MiddlewareNoDataOrNextCalled, x as MiddlewareNotAResponse, G as GetStaticPathsRequired, y as InvalidGetStaticPathsReturn, z as InvalidGetStaticPathsEntry, B as GetStaticPathsExpectedParams, C as GetStaticPathsInvalidRouteParam, H as trimSlashes, P as PageNumberParamNotFound, J as NoMatchingStaticPathFound, K as PrerenderDynamicEndpointPathCollide, L as ReservedSlotName, Q as removeTrailingForwardSlash, S as RewriteWithBodyUsed, T as LocalsNotAnObject, W as PrerenderClientAddressNotAvailable, X as ClientAddressNotAvailable, Y as StaticClientAddressNotAvailable, Z as AstroResponseHeadersReassigned, _ as fileExtension, $ as slash$1, p as prependForwardSlash } from './astro/assets-service_DGOMzPV2.mjs';
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, D as DEFAULT_404_ROUTE, a as default404Instance, N as NOOP_MIDDLEWARE_FN } from './astro-designed-error-pages_BPWP8urZ.mjs';
...
const getStarExtglobSequenceOutput = pattern => {
  ...
  const source = chars.length === 1
    ? utils$d.escapeRegex(chars[0])
    : `[${chars.map(ch => utils$d.escapeRegex(ch)).join('')}]`;
...
const parse$1 = (input, options) => {
  ...
  const extglobClose = token => {
    ...
    if ((token.type === 'plus' || token.type === 'star') && analysis.risky) {
      ...
      open.type = 'text';
      open.value = literal;
      open.output = safeOutput || utils$d.escapeRegex(literal);
